...
public class BottomMenuDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public BottomMenuDialog create() {
            final BottomMenuDialog dialog = new BottomMenuDialog(p.context, shadow ? R.style.Mb_Light_NoTitle_Dialog : R.style.Mb_Light_NoTitle_NoShadow_Dialog);
            Window window = dialog.getWindow();
            window.setWindowAnimations(R.style.Mb_Animation_Bottom_Rising);
