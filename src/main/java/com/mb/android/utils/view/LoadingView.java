package com.mb.android.utils.view;
...
public class LoadingView extends ViewGroup{
    ...
    public LoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            t = context.obtainStyledAttributes(attrs, R.styleable.LoadingView,
                    0, defStyleAttr);
            setbTransparent(t.getBoolean(R.styleable.LoadingView_bg_transparent, false));
            alpha = t.getDimensionPixelSize(R.styleable.LoadingView_bg_alpha,
                    255);
        } finally {
            if (t != null) {
                t.recycle();
...
//        return super.onInterceptTouchEvent(ev);
    ...
    public ViewGroup.LayoutParams generateLayoutParams(
            AttributeSet attrs) {
        return new LoadingView.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof LoadingView.LayoutParams;
    }
